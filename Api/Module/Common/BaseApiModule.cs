...
namespace Service.Api.Module.Common
{
    public abstract class BaseApiModule
    {
        ...
        // protected void SendPromiseStatus(IClient client, int promiseId, long eventId, PromiseStates state, IMessage message)
        // {
        //     client.SendPromiseStatus(promiseId, eventId, state, message);
        // }
