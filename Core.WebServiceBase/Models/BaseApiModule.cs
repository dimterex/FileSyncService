...
using SdkProject.Api.Sync;
    ...
    public abstract class BaseApiModule
    {
        ...
        protected BaseApiModule(string name, IApiController apiController)
        {
        ...
        private void RegisterRequest<T>(string httpMethod, string resourceName, Action<T, HttpRequestEventModel> method)
        {
            ...
            _restMethods.Add($"{httpMethod} /{Name}/{resourceName}", e => method(DeserializeRequest<T>(e.Request.QueryString), e));
        }
